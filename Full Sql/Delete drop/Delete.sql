create table customers11(
	...
	insert into customers11(cust_id, cust_name, cust_address, cust_phone, email) values 
...
delete from customers11 where cust_id=2;

select * from customers11;

delete from customers11 where cust_name ='Ayesha Shah'; 

select * from customers11;

-- Delete will delete the rwos without deleting the table 
