create table customers9(
	...
	insert into customers9(cust_id, cust_name, cust_address, cust_phone, email) values 
...
select * from customers9 where not cust_id= 3;

select * from products where price not between 10 and 11;

select * from customers9 where cust_name not in ('Sara Khan' , 'Kamran Ali'); 

select * from customers9 where not  cust_id < 4;