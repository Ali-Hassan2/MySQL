create table customers20(
	...
	insert into customers20(cust_id, cust_name, cust_address, cust_phone, email) values 
...
select * from customers20 where cust_name like 'a%';

select * from customers20 where cust_name like'%e';

-- which have this letter in this name a

select * from customers20 where cust_name like'%a%';

-- start and end

select * from customers20 where cust_name like 'K%' or cust_name like'%i'; 

-- where start from this letter and end with letter

select* from customers20 where cust_name like'K%i';

select *  from customers20 where cust_name like'a__%';
