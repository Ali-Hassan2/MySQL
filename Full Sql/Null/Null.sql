...
insert into products12 (id,product_name, description, price) values
...
-- Null
select price from products12 where price is null;

select product_name from products12 where product_name is not null;