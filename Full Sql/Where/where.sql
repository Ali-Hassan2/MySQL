create table customers3(
	...
	insert into customers3(cust_id, cust_name, cust_address, cust_phone, email) values 
...
select * from customers2 where cust_name = 'Ahmed Malik';

select *from customers3 where cust_id > 5;
