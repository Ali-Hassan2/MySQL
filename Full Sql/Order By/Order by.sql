create table customers4(
	...
	insert into customers4(cust_id, cust_name, cust_address, cust_phone, email) values 
...
insert into products10 (id,product_name, description, price) values
...
select * from products10 order by price;

select * from products10 order by price desc;

select * from products10 order by price asc, id desc;