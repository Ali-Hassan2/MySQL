create table customers22(
	...
	insert into customers22(cust_id, cust_name, cust_address, cust_phone, email) values 
...
select *  from customers22 where cust_name in ('Sara Khan','Daniel Brown','Kamran Ali');

select * from customers22 where cust_name not in('Sara Khan','Daniel Brown','Kamran Ali');
