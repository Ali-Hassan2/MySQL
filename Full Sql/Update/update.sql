create table customers10(
	...
	insert into customers10(cust_id, cust_name, cust_address, cust_phone, email) values 
...
update customers10 set cust_name = 'Ali Hassan', cust_phone = '03187801213' where cust_id = 2;
