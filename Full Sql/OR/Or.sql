create table customers7(
	...
	insert into customers7(cust_id, cust_name, cust_address, cust_phone, email) values 
...
select * from customers7 where cust_name='Sara Khan' or cust_name= 'Emily Smith';
