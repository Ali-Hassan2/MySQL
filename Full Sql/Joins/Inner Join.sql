...
select *  from Category as c inner join Product as p on c.CategoryID = p.CategoryID;

select CategoryName from Category as cn inner join Product as pr on cn.CategoryID = pr.CategoryID;
