create table customers1(
	...
	insert into customers1(id, cust_name, cust_address, cust_phone, email) values 
...
-- DISTINCT TO SHOW THE DIFFERENT VALUES

select distinct id from customers;

select DISTINCT cust_name, cust_address from customers;
